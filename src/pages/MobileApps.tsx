        ...
        <section className="mb-16">
          <GlassCard>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div>
                <h3 className="font-semibold text-white/95 mb-2">Native iOS</h3>
                <p className="text-white/80 text-sm">Swift, Objective-C, Xcode, Core Data</p>
              </div>
              <div>
                <h3 className="font-semibold text-white/95 mb-2">Native Android</h3>
                <p className="text-white/80 text-sm">Kotlin, Java, Android Studio, Room</p>
              </div>
              <div>
                <h3 className="font-semibold text-white/95 mb-2">Cross-Platform</h3>
                <p className="text-white/80 text-sm">React Native, Flutter, Xamarin</p>
              </div>
            </div>
          </GlassCard>
        </section>
