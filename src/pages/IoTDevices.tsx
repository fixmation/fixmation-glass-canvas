          ...
          <GlassCard>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                ...
                <p className="text-white/80 text-sm">ESP32, Arduino, Raspberry Pi, STM32</p>
              </div>
              <div>
                <h3 className="font-semibold text-white/95 mb-2">Connectivity</h3>
                <p className="text-white/80 text-sm">WiFi, Bluetooth, LoRa, Zigbee, 4G/5G</p>
              </div>
              <div>
                <h3 className="font-semibold text-white/95 mb-2">Cloud</h3>
                <p className="text-white/80 text-sm">AWS IoT, Azure IoT, Google Cloud IoT</p>
              </div>
              <div>
                <h3 className="font-semibold text-white/95 mb-2">Protocols</h3>
                <p className="text-white/80 text-sm">MQTT, CoAP, HTTP/HTTPS, WebSocket</p>
              </div>
            </div>
          </GlassCard>
        </section>
